  ...
  async function handleRequestOtp(e) {
    ...
    try {
      ...
      if (data.dev_otp) {
        ...
        toast.success(`OTP sent via ${data.delivery_mode || 'SMS'}`)
      }
    } catch (err) {
...
const styles = {
  ...
  title: { color: '#fff', fontFamily: 'Poppins,sans-serif', fontSize: 28, fontWeight: 700, letterSpacing: 0.5, marginBottom: 4 },
